...
def litCricFriend(wordList, text):
    ...
    for word in textList:
        perfectList.append(''.join(e for e in word if e.isalnum()))
    ...
    for word in wordList:
        word.lower()
        wordFreq[word] = perfectList.count(word)
    ...
    textLength = len(perfectList)
    ratioList = []
    for freq in wordFreq:
        ratio = wordFreq[freq]/textLength
        ratioList.append(str(freq + " " + str(ratio)))
    return ratioList
...
print("Statistics on 'The Bells': \n" + str(litCricFriend(['a', 'an'], theBells)))
print("Statistics on 'Canto XII': \n" + str(litCricFriend(['a', 'an'], cantoXII)))
print("Statistics on 'The Bells': \n" + str(litCricFriend(['the'], theBells)))
print("Statistics on 'Canto XII': \n" + str(litCricFriend(['the'], cantoXII)))
...
Both authors barely use the article 'an'. Neruda only uses it once while Poe never does.
Poe uses the article 'a' significantly more than Neruda.
Poe also uses 'the' a lot more than Neruda. The difference isn't as big as the difference in the use of 'a' however.
For both authors, 'the' is the most widely used article and 'an' is the least used article.
'''
